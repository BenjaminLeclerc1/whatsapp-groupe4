...
//     updateChat,
//     deleteChat,
//     getHistory, // --- ADDED: Import from context ---
//   } = useApp();
...
//   // --- ADDED: Function to handle history fetching ---
//   const handleLoadHistory = async () => {
//     if (selectedChat) {
//       await getHistory(selectedChat.id);
//       setShowHeaderMenu(false); // Close menu after click
//     }
//   };
...
//       updateChat(chat.id, { name: newName }); // Envoie {"name": "Nom"} -> Le backend accepte (200)
//     }
//   };
...
//                     }}
//                   >
//                     <span className="material-icons" style={{backgroundColor: 'gray', padding:'0px 15px 7px 15px', marginLeft: '20px', display:'flex', alignItems:'center'}}>...</span>
//                   </button>
            ...
            {loading && chats.length === 0 ? (
              ...
              [...chats]
                ...
                .map((chat) => (
                  ...
                  >
                    <div className="card-avatar">
                      <span className="material-icons">{chat.type === "group" ? "groups" : "person"}</span>
                    </div>
                    <div className="card-info">
                      <div className="card-row">
            ...
            <div className="active-chat-window">
                ...
                <div className="header-actions">
                  ...
                  {showHeaderMenu && (
                    <div className="msg-popup-menu" style={{ display: "block", top: "45px", right: "10px" }}>
                      <button className="menu-item" onClick={handleLoadHistory}>Voir l'historique</button>
                      <button className="menu-item delete" onClick={(e) => onDeleteChat(e, selectedChat)}>Supprimer le chat</button>
                    </div>
                  )}
                </div>
              </header>
              ...
              <footer className="chat-input-area">
                ...
                <form onSubmit={handleSend} className="input-form">
                  ...
                  />
                  <button type="submit" className="send-btn">
                    <span className="material-icons">{newMessage.trim() ? "send" : "mic"}</span>
                  </button>
                </form>
              </footer>
            </div>
